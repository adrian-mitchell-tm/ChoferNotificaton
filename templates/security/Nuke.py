                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                                ...
                                <tr>
                                    ...
                                    <div style="font-family:helvetica;font-size:28px;line-height:1;text-align:left;color:white;">
                                        AWS Sandbox Nuke Notification</div>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="mj-column-per-95 mj-outlook-group-fix"
                            ...
                            <tbody>
                                ...
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <p>We will remove the resources from the sandbox AWS accounts on Sunday. 
                                        Please, save your work offline or migrate the resources to a non-production account.</p>
                                    </div>
                                </td>
                                </tr>
                            </tbody>
