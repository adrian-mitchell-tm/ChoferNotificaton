                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                          <div style="font-family:helvetica;font-size:28px;line-height:1;text-align:left;color:white;">Security Policy Violation</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                            ...
                                            <tbody>
                                              <tr>
                                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:32px;padding-bottom:20px;word-break:break-word;">
                                                  <div style="font-family:helvetica;font-size:24px;line-height:1;text-align:left;color:#000000;">Greetings from the Cloud Engineering Team</div>
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
                                    ...
                                    <tr>
                                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                        <div style="font-family:helvetica;font-size:14px;line-height:1;text-align:left;color:#000000;">
                                          <p> You have non-compliant resources, please check them on the <a href="https://app.powerbi.com/groups/me/apps/ebf0ed65-fdee-458e-b0c9-a4f851919f5b/reports/4b89fe13-15ba-4252-8843-a0f4c2cad61c/ReportSection9e45d06cbede82a27c07">security scorecard dashboard</a>. </p>
                                        </div>
                                      </td>
                                    </tr>
                                  </tbody>
