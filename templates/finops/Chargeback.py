                        ...
                        <div class="mj-column-per-95 mj-outlook-group-fix"
                            ...
                            <tbody>
                                ...
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    ...
                                    <p> Your {cloud} Chargebacks for the {month}. is ready. For further Account level distribution of the chargebacks, please check out the <a href="https://chofer.cloud.toyota.com">Chofer Portal</a>. </p>
                                    </div>
                                </td>
                                </tr>
                            </tbody>
